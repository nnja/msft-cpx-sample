"""
This demo code for Adafruit's CircuitPlayground Express (CPX)
device is optimized for the Device Simulator Express Visual
...
TODO:
- Add licensor name and year to LICENSE file.
"""
